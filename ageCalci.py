...
def check_for_errors():
    ...
    if (
            birth_year_field.get() == "" or birth_month_field.get() == "" or birth_day_field.get() == "" or given_year_field.get() == "" or given_month_field.get() == "" or given_day_field.get() == ""):
...
if __name__ == "__main__":
    ...
    my_window.title("Age Calculator - D'Eagle")
    # setting the geometry of the application
    my_window.geometry("600x450+650+250")
    # disabling the resizable option
    my_window.resizable(0, 0)
    # configuring the background color of the application
    my_window.config(bg="#DD2694")
    # setting the icon for the application
    my_window.iconbitmap('calendar_img.png')

    # creating frames to provide better structure for other widgets
    header_frame = Frame(my_window, bg="#dd2694")
    entry_frame = Frame(my_window, bg="#DD2694")
    result_frame = Frame(my_window, bg="#DD2694")
    ...
    close_button.grid(row=2, column=3, padx=10, pady=10)
